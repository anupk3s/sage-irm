...
export const MOCK_OPPORTUNITIES: Opportunity[] = [
  ...
  },
  {
    ...
    description: "ERISA diversification requirement creates a need for infrastructure allocation. Well-positioned to win given existing relationship and Isaiah Langer's LDI expertise. High probability close.",
