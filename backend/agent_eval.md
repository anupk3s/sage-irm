...
In this article we show examples of IntentResolution, ToolCallAccuracy, and TaskAdherence. For examples of using other evaluators with Azure AI agent messages, see evaluating Azure AI agents.
